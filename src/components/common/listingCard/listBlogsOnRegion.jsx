  ...
  return (
    <li class="blog-item">
      {props.loading ? (
        ...
        <div className="blog-box card-box-shadow">
          ...
          <div class="blog-box-content">
            ...
            >
              <div class="bbc-body mt-2">
                <h6 className="caps-text title-hover">
                  {dotDesc(HTMLReactParser(removeTags(props.name)), 25)}
                </h6>
                <p>
...
export default ListBlogsOnRegion;
