...
import { getAllZoo, getZoo, zooListings } from "../../store/zoo";
...
const RegionListing = (props) => {
  ...
  const totalPages =
    (props.zooListings?.zoo && props.zooListings?.zoo?.totalCount) || 0;

  const dataPerPage =
    (props.zooListings?.zoo && props.zooListings?.zoo?.recordsPerPage) || 0;
...
const mapDispatchToProps = (dispatch) => ({
  getAllZoo: (params, callback) => dispatch(getZoo(params, callback)),
