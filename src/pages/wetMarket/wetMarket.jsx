...
import { sideBarApisListings, getRegionList, getSpeciesList, getOrganizationList } from "../../store/sidebarApis";
import ShowMoreModal from "../../components/common/showMoreModal/showMoreModal";
import noRecord from "../../include/images/nrb-img.svg";
import { getwetmarket, wetMarketData } from "../../store/wetMarket";
...
const WetMarketListing = (props) => {
  ...
  useEffect(() => {
    ...
    props.getwetmarket(payload, (res) => {
  ...
  const WetMarketList =
    props.wetMarketData?.wetMarket && props.wetMarketData.wetMarket.data;

  const totalPages =
    (props.wetMarketData?.wetMarket &&
      props.wetMarketData.wetMarket.totalCount) ||
    0;

  const dataPerPage =
    (props.wetMarketData?.wetMarket &&
      props.wetMarketData.wetMarket?.recordsPerPage) ||
    0;
                  ...
                  <div class="listing-container-inner d-flex flex-wrap">
                    ...
                    <div class="listing-content-box">
                      <div class="breadcrumb-row d-flex flex-wrap">
                        ...
                        <div class="breadcrumb-box">
                          <Link to="/war-on-the-environment-threats">War on the Environment- Threats</Link>
                        </div>
                      </div>
                      <div class="ei-heading listing-content-heading-mob">
                        <h4>All War on the Environment- Threats</h4>
                      ...
                      <div class="pagination-row d-flex justify-content-between">
                        {WetMarketList && WetMarketList.length === 0 ? (
...
const mapDispatchToProps = (dispatch) => ({
  getwetmarket: (params, callback) => dispatch(getwetmarket(params, callback)),
